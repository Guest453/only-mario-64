...
function reportGames() {
    ...
    const list = launcher.availableGames().map((g) => ({
        ...
        // kind/hidden let the client keep containers out of the games picker
        // and show them in the Containers tab instead.
        kind: g.kind || null, hidden: !!g.hidden, desc: g.desc || '',
    }));
